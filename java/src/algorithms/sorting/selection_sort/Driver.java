...
/**
 * Driver class for demonstrating the Selection Sort algorithm.
 * 
 * @author bjornmelin
 * @version 1.0
 * @since 2025-01-25
...
public class Driver {
    ...
    public static void main(String[] args) {
        ...
        long timeTaken = SelectionSort.sort(items);
        System.out.println("\nAfter sorting:");
        printList(items);
        System.out.println("\nTime taken: " + timeTaken + " nanoseconds");
        System.out.println("Is sorted: " + SelectionSort.isSorted(items));
    }
