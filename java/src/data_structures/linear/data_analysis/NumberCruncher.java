package data_structures.linear.data_analysis;

import java.util.*;

/**
 * Number cruncher class which contains the main method of this
 * program.  Runs the desired testing on each Data Structure in
 * this study.
 * @author bjornmelin
 */
