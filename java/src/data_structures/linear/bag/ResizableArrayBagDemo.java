...
/** 
 * A demonstration of the class ResizableArrayBag. Tests Union, Intersection, Difference, and Equals Methods
 * @author bjornmelin
 */
public class ResizableArrayBagDemo
{
    public static void main(String[] args)
    {
        ...
        System.out.println("\nBags: aBag and bBag are equal: " + ((ResizableArrayBag<String>)aBag).equals((ResizableArrayBag<String>)bBag) + "\n\n");
