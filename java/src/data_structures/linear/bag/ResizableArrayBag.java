...
/**
 * A class that implements a bag of objects by using an array. Implements the
 * Union, Equals, Difference, and Intersection Methods for additional bags.
 * 
 * @author bjornmelin
 */
public final class ResizableArrayBag<T> implements BagInterface<T> {
     ...
     * @return boolean denoting whether it is okay or not to add this entry to the
     *         bag,
     ...
     * To be equal, the Bags must have the same number of elements and have the same
     * element values inside both Bags.
